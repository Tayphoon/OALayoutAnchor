...
#import "NSView+OALayoutAnchorInternals.h"
...
+ (void)load {
  [NSView addAnchorMethodsIfNeeded];
}
...
- (void)addConstraint:(NSLayoutConstraint*)constraint betweenView:(NSView*)view otherView:(NSView*)otherView {
  NSView *parent = [self viewToAddConstraintOnForFirstView:self.view secondView:otherView];
  [parent addConstraint:constraint];
  constraint.active = NO;
}

- (NSView*)viewToAddConstraintOnForFirstView:(NSView*)firstView secondView:(NSView*)secondView {
  if (firstView == nil || secondView == nil) {
    return nil;
  }
  
  if (secondView.superview == firstView) {
    return secondView;
  }
...
- (void)addConstraint:(NSLayoutConstraint*)constraint toView:(NSView*)view {
