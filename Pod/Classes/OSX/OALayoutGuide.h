...
/* The guide must be added to a view with -[NSView addLayoutGuide:] before being used in a constraint.
 Do not use this property directly to change the owningView of a layout guide. Instead, use
 -[NSView addLayoutGuide:] and -[NSView removeLayoutGuide:], which will use this property to
